        ...
        <form method="POST">
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="form-control">
                    ...
                    <input name="appId" type="text" value="<?php echo $row['app_id']; ?>"
                ...
                <div class="form-control">
                    ...
                    <input name="adsId" type="text" value="<?php echo $row['ad_id']; ?>"
                        class="input input-bordered bg-transparent border-2 border-black text-black" required />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input name="marqueryNotice" type="text" value="<?php echo $row['marquery_notice']; ?>"
                        class="input input-bordered bg-transparent border-2 border-black text-black" required />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input name="appVersion" type="number" value="<?php echo $row['app_version']; ?>"
                        class="input input-bordered bg-transparent border-2 border-black text-black" required />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input name="appUpdateUrl" type="text" value="<?php echo $row['app_update_url']; ?>"
                        class="input input-bordered bg-transparent border-2 border-black text-black" required />
                </div>
